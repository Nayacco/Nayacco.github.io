...
![二叉树](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/二叉树.png)
...
![堆](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/堆.png)
...
![线段树](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/线段树.png)
...
![压缩字典树](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/压缩字典树.png)
...
![并查集](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/并查集.png)
![并查集路径压缩](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/并查集路径压缩.png)

## 平衡二叉树

- 任意一个节点的左子树和右子树高度差不超过 1

![平衡二叉树](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/平衡二叉树.png)

- 计算平衡因子：左右子树的高度差的绝对值不能超过 1，超过 1 说明不平衡

![平衡二叉树的平衡因子](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/平衡二叉树的平衡因子.png)

## AVL

- 维护一个height，插入或删除节点的时候，根据平衡因子，判断是否是平衡树，如果不平衡，通过调整根节点，使树始终保持平衡状态

![AVL右旋转](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/AVL右旋转.png)
...
![2-3树](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/2-3树.png)

2-3树是如何维持绝对平衡的？

![2-3树融合-0](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/2-3树融合-0.png)
![2-3树融合-1](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/2-3树融合-1.png)
![2-3树融合-2](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/2-3树融合-2.png)
![2-3树融合-3](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/2-3树融合-3.png)
...
![红黑树与2-3树对照-1](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/红黑树与2-3树对照-1.png)
...
![哈希素数](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/哈希素数.png)

如果是浮点型，计算机都是用32位或64位二进制存储的，所以可以转换为整型  
如果是字符串，可以将每个字符看成是26进制，也可以转换成整型

![哈希表Java实现](https://gcore.jsdelivr.net/gh/Nayacco/cdn@master/blog/哈希表Java实现.png)